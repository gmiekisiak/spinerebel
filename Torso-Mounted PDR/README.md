...
> G. Miekisiak, "Torso-Mounted Pedestrian Dead Reckoning Using Nadir-Based Zero-Cycle Heading and Differential Accelerometry," *IEEE Sensors Letters*, 2026, 10(8), 6007204. doi:10.1109/LSENS.2026.3702726
...
`LICENSE` and `CITATION.cff` live at the repository root.
